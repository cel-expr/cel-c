...
#include "cel-c/src/parsed_repeated_field_value.h"
#include "cel-c/timestamp.h"
...
const cel_Value cel_FalseValue = {
    .data =
        {
            .bl = false,
        },
...
cel_StringView cel_Value_TypeName(const cel_Value* cel_nonnull value) {
...
bool cel_Value_Equals(const cel_Value* cel_nonnull value,
...
bool cel_Value_FromMessage(cel_Value* cel_nonnull value,
                           const cel_ValueContext* cel_nonnull context,
...
bool cel_Value_FromEnum(cel_Value* cel_nonnull value,
                        const cel_ValueContext* cel_nonnull context,
                        int32_t enum_val,
...
bool cel_Value_FromEnumValue(cel_Value* cel_nonnull value,
                             const cel_ValueContext* cel_nonnull context,
                             const upb_EnumValueDef* enum_val,
                             cel_Status* cel_nonnull status) {
  CEL_ASSERT_NOT_NULL(value);
...
bool cel_Value_FromField(cel_Value* cel_nonnull value,
                         const cel_ValueContext* cel_nonnull context,
...
bool cel_Value_FromRepeatedFieldElement(
    cel_Value* cel_nonnull value, const cel_ValueContext* cel_nonnull context,
    upb_MessageValue field_val, const upb_FieldDef* cel_nonnull field_def,
    cel_Status* cel_nonnull status) {
  CEL_ASSERT_NOT_NULL(value);
...
bool cel_Value_FromMapFieldKey(cel_Value* cel_nonnull value,
                               const cel_ValueContext* cel_nonnull context,
                               upb_MessageValue field_val,
                               const upb_FieldDef* cel_nonnull field_def,
                               cel_Status* cel_nonnull status) {
...
bool cel_Value_FromMapFieldValue(cel_Value* cel_nonnull value,
                                 const cel_ValueContext* cel_nonnull context,
                                 upb_MessageValue field_val,
                                 const upb_FieldDef* cel_nonnull field_def,
                                 cel_Status* cel_nonnull status) {
