...
bool cel_Constant_ToProto(CEL_NONNULL(const cel_Constant*) in,
                          CEL_NONNULL(upb_Arena*) arena,
                          CEL_NONNULL(cel_expr_Constant*) out,
  ...
  switch (cel_Constant_Kind(in)) {
    case cel_ConstantKind_kUnspecified:
      cel_expr_Constant_clear_constant_kind(out);
      break;
    case cel_ConstantKind_kNull:
      cel_expr_Constant_set_null_value(out, google_protobuf_NULL_VALUE);
      break;
    case cel_ConstantKind_kBool:
      cel_expr_Constant_set_bool_value(out, cel_Constant_GetBool(in));
      break;
    case cel_ConstantKind_kInt:
      cel_expr_Constant_set_int64_value(out, cel_Constant_GetInt(in));
      break;
    case cel_ConstantKind_kUint:
      cel_expr_Constant_set_uint64_value(out, cel_Constant_GetUint(in));
      break;
    case cel_ConstantKind_kDouble:
      cel_expr_Constant_set_double_value(out,
                                                cel_Constant_GetDouble(in));
      break;
    case cel_ConstantKind_kBytes:
      cel_expr_Constant_set_bytes_value(out, cel_Constant_GetBytes(in));
      break;
    case cel_ConstantKind_kString:
      cel_expr_Constant_set_string_value(out,
                                                cel_Constant_GetString(in));
      break;
    case cel_ConstantKind_kDuration: {
      ...
      cel_expr_Constant_set_duration_value(out, out_duration);
    } break;
    case cel_ConstantKind_kTimestamp: {
      ...
      cel_expr_Constant_set_timestamp_value(out, out_timestamp);
    } break;
    default:
...
bool cel_Constant_FromProto(CEL_NONNULL(cel_Constant*) out,
                            CEL_NONNULL(const cel_expr_Constant*) in,
  ...
  switch (cel_expr_Constant_constant_kind_case(in)) {
    case cel_expr_Constant_constant_kind_NOT_SET:
      *out = cel_UnspecifiedConstant();
      break;
    case cel_expr_Constant_constant_kind_null_value:
      cel_Constant_SetNull(out);
      break;
    case cel_expr_Constant_constant_kind_bool_value:
      cel_Constant_SetBool(out, cel_expr_Constant_bool_value(in));
      break;
    case cel_expr_Constant_constant_kind_int64_value:
      cel_Constant_SetInt(out, cel_expr_Constant_int64_value(in));
      break;
    case cel_expr_Constant_constant_kind_uint64_value:
      cel_Constant_SetUint(out, cel_expr_Constant_uint64_value(in));
      break;
    case cel_expr_Constant_constant_kind_double_value:
      cel_Constant_SetDouble(out, cel_expr_Constant_double_value(in));
      break;
    case cel_expr_Constant_constant_kind_bytes_value: {
      cel_StringView val = cel_expr_Constant_bytes_value(in);
    ...
    case cel_expr_Constant_constant_kind_string_value: {
      cel_StringView val = cel_expr_Constant_string_value(in);
      if (!cel_Arena_StrDup(arena, &val, val)) {
        cel_OutOfMemoryStatus(status);
        return false;
      }
    ...
    case cel_expr_Constant_constant_kind_duration_value: {
      CEL_NULLABILITY_UNKNOWN(const google_protobuf_Duration*)
      in_duration = cel_expr_Constant_duration_value(in);
    ...
    case cel_expr_Constant_constant_kind_timestamp_value: {
      CEL_NULLABILITY_UNKNOWN(const google_protobuf_Timestamp*)
      in_timestamp = cel_expr_Constant_timestamp_value(in);
    ...
    default:
      cel_InvalidArgumentStatusF(
          ...
          cel_expr_Constant_constant_kind_case(in));
      return false;
  }
  return true;
}
