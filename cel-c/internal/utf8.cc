...
extern "C" void _cel_Utf8_Decode(upb_StringView str,
                                 CEL_NULLABLE(char32_t*) pnt,
                                 CEL_NULLABLE(size_t*) units) {
...
extern "C" size_t _cel_Utf8_Encode(char32_t pnt, CEL_NONNULL(char*) str,
                                   size_t len) {
...
extern "C" size_t _cel_Utf8_DecodedSize(upb_StringView str) {
  size_t pnts = 0;
  size_t units;
  while (str.size > 0) {
...
extern "C" bool _cel_Utf8_IsValid(upb_StringView str) {
  char32_t pnt;
  size_t units;
  while (str.size > 0) {
