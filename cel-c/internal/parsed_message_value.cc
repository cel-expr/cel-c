...
extern const cel_StructValueIteratorVTable
...
extern "C" const cel_StructValueVTable _cel_ParsedMessageValueVTable = {
...
const cel_StructValueIteratorVTable _cel_ParsedMessageValueIteratorVTable = {
