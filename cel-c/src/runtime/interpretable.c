...
static inline cel_StringView _cel_Interpretable_Concat(
  ...
  char* data = cel_Arena_Malloc(interp->arena, size, cel_nullptr);
...
static inline void _cel_Interpretable_CallString(
  ...
  switch (cel_Value_Kind(top)) {
    ...
    case cel_ValueKind_kInt: {
      long long value = cel_Value_GetInt(top);
      cel_Value_SetString(top,
                          _cel_Interpretable_FromIntToChars(interp, value));
    } break;
    case cel_ValueKind_kUint: {
      unsigned long long value = cel_Value_GetUint(top);
      cel_Value_SetString(top,
...
static inline void _cel_Interpretable_ComputedGoto(
  ...
  static const void* const dispatch_table[] = {
      [_cel_InstrKind_kUnreachable] = &&INSTR_UNREACHABLE,
      [_cel_InstrKind_kNullConst] = &&INSTR_NULL_CONST,
      [_cel_InstrKind_kFalseConst] = &&INSTR_FALSE_CONST,
      [_cel_InstrKind_kTrueConst] = &&INSTR_TRUE_CONST,
      [_cel_InstrKind_kIntConst] = &&INSTR_INT_CONST,
      [_cel_InstrKind_kUintConst] = &&INSTR_UINT_CONST,
      [_cel_InstrKind_kDoubleConst] = &&INSTR_DOUBLE_CONST,
      [_cel_InstrKind_kBytesConst] = &&INSTR_BYTES_CONST,
      [_cel_InstrKind_kStringConst] = &&INSTR_STRING_CONST,
      [_cel_InstrKind_kDurationConst] = &&INSTR_DURATION_CONST,
      [_cel_InstrKind_kTimestampConst] = &&INSTR_TIMESTAMP_CONST,
      [_cel_InstrKind_kIdent] = &&INSTR_IDENT,
      [_cel_InstrKind_kIdentJump] = &&INSTR_IDENT_JUMP,
      [_cel_InstrKind_kContIdent] = &&INSTR_CONT_IDENT,
      [_cel_InstrKind_kContIdentJump] = &&INSTR_CONT_IDENT_JUMP,
      [_cel_InstrKind_kJump] = &&INSTR_JUMP,
      [_cel_InstrKind_kHas] = &&INSTR_HAS,
      [_cel_InstrKind_kMessageHas] = &&INSTR_MESSAGE_HAS,
      [_cel_InstrKind_kSelect] = &&INSTR_SELECT,
      [_cel_InstrKind_kMessageSelect] = &&INSTR_MESSAGE_SELECT,
      [_cel_InstrKind_kAdd] = &&INSTR_ADD,
      [_cel_InstrKind_kSubtract] = &&INSTR_SUBTRACT,
      [_cel_InstrKind_kMultiply] = &&INSTR_MULTIPLY,
      [_cel_InstrKind_kDivide] = &&INSTR_DIVIDE,
      [_cel_InstrKind_kModulo] = &&INSTR_MODULO,
      [_cel_InstrKind_kLogicalNot] = &&INSTR_LOGICAL_NOT,
      [_cel_InstrKind_kNegate] = &&INSTR_NEGATE,
      [_cel_InstrKind_kLogicalAnd] = &&INSTR_LOGICAL_AND,
      [_cel_InstrKind_kLogicalOr] = &&INSTR_LOGICAL_OR,
      [_cel_InstrKind_kEquals] = &&INSTR_EQUALS,
      [_cel_InstrKind_kNotEquals] = &&INSTR_NOT_EQUALS,
      [_cel_InstrKind_kLess] = &&INSTR_LESS,
      [_cel_InstrKind_kLessEquals] = &&INSTR_LESS_EQUALS,
      [_cel_InstrKind_kGreater] = &&INSTR_GREATER,
      [_cel_InstrKind_kGreaterEquals] = &&INSTR_GREATER_EQUALS,
      [_cel_InstrKind_kCondJump] = &&INSTR_COND_JUMP,
      [_cel_InstrKind_kTrileanJump] = &&INSTR_TRILEAN_JUMP,
      [_cel_InstrKind_kErrorJump] = &&INSTR_ERROR_JUMP,
      [_cel_InstrKind_kList] = &&INSTR_LIST,
      [_cel_InstrKind_kKeyJump] = &&INSTR_KEY_JUMP,
      [_cel_InstrKind_kMap] = &&INSTR_MAP,
      [_cel_InstrKind_kCallBool] = &&INSTR_CALL_BOOL,
      [_cel_InstrKind_kCallInt] = &&INSTR_CALL_INT,
      [_cel_InstrKind_kCallUint] = &&INSTR_CALL_UINT,
      [_cel_InstrKind_kCallDouble] = &&INSTR_CALL_DOUBLE,
      [_cel_InstrKind_kCallBytes] = &&INSTR_CALL_BYTES,
      [_cel_InstrKind_kCallString] = &&INSTR_CALL_STRING,
      [_cel_InstrKind_kCallTimestamp] = &&INSTR_CALL_TIMESTAMP,
      [_cel_InstrKind_kCallDuration] = &&INSTR_CALL_DURATION,
      [_cel_InstrKind_kCallSize] = &&INSTR_CALL_SIZE,
      [_cel_InstrKind_kCallContainsString] = &&INSTR_CALL_CONTAINS_STRING,
      [_cel_InstrKind_kCallStartsWithString] = &&INSTR_CALL_STARTS_WITH_STRING,
      [_cel_InstrKind_kCallEndsWithString] = &&INSTR_CALL_ENDS_WITH_STRING,
      [_cel_InstrKind_kCallRegexExpMatch] = &&INSTR_CALL_REGEX_EXP_MATCH,
      [_cel_InstrKind_kIndex] = &&INSTR_INDEX,
      [_cel_InstrKind_kIn] = &&INSTR_IN,
      [_cel_InstrKind_kLazyCall] = &&INSTR_LAZY_CALL,
      [_cel_InstrKind_kLazyReturn] = &&INSTR_LAZY_RETURN,
      [_cel_InstrKind_kLazyEnter] = &&INSTR_LAZY_ENTER,
      [_cel_InstrKind_kLazyLeave] = &&INSTR_LAZY_LEAVE,
      [_cel_InstrKind_kExit] = &&INSTR_EXIT,
  };
