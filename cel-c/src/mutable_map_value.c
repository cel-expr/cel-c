...
static const cel_MapValueIteratorVTable _cel_MutableMapValueIteratorVTable;
...
_cel_MutableMapValueInsertResult _cel_MutableMapValue_Insert(
  ...
  ent = cel_Arena_Malloc(arena, sizeof(_cel_MutableMapValueEntry), cel_nullptr);
...
const cel_MapValueVTable _cel_MutableMapValueVTable = {
    .Equals = cel_nullptr,
