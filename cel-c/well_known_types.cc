...
extern "C" bool cel_NullValueWellKnownType_Initialize(
  ...
  if (CEL_UNLIKELY(value_def == cel_nullptr)) {
    cel_NotFoundStatus(status, cel_StringView_From(
                                   "cel: well known enum type value not found: "
...
extern "C" bool cel_BoolValueWellKnownType_Initialize(
    cel_BoolValueWellKnownType* cel_nonnull wkt,
    const upb_DefPool* cel_nonnull def_pool, cel_Status* cel_nonnull status) {
...
extern "C" bool cel_Int32ValueWellKnownType_Initialize(
...
extern "C" bool cel_UInt32ValueWellKnownType_Initialize(
...
extern "C" bool cel_Int64ValueWellKnownType_Initialize(
...
extern "C" bool cel_UInt64ValueWellKnownType_Initialize(
...
extern "C" bool cel_FloatValueWellKnownType_Initialize(
...
extern "C" bool cel_DoubleValueWellKnownType_Initialize(
...
extern "C" bool cel_BytesValueWellKnownType_Initialize(
...
extern "C" bool cel_StringValueWellKnownType_Initialize(
...
extern "C" bool cel_DurationWellKnownType_Initialize(
...
extern "C" bool cel_TimestampWellKnownType_Initialize(
...
extern "C" bool cel_AnyWellKnownType_Initialize(
...
extern "C" bool cel_ValueWellKnownType_Initialize(
...
extern "C" bool cel_StructWellKnownType_Initialize(
...
extern "C" bool cel_ListValueWellKnownType_Initialize(
...
extern "C" bool cel_FieldMaskWellKnownType_Initialize(
...
extern "C" bool cel_WellKnownTypes_Initialize(
