...
#ifndef THIRD_PARTY_CEL_C_SRC_PARSED_MAP_FIELD_VALUE_H_
#define THIRD_PARTY_CEL_C_SRC_PARSED_MAP_FIELD_VALUE_H_
...
#endif  // THIRD_PARTY_CEL_C_SRC_PARSED_MAP_FIELD_VALUE_H_
