...
bool cel_Timestamp_Add(cel_Timestamp* cel_nonnull out, cel_Timestamp lhs,
                       cel_Duration rhs) {
...
bool cel_Timestamp_Sub(cel_Timestamp* cel_nonnull out, cel_Timestamp lhs,
                       cel_Duration rhs) {
  CEL_ASSERT_NOT_NULL(out);
  CEL_ASSERT(cel_Timestamp_Valid(lhs.sec, lhs.nsec));
  CEL_ASSERT(cel_Duration_Valid(rhs.sec, rhs.nsec));
...
bool cel_Timestamp_Diff(cel_Duration* cel_nonnull out, cel_Timestamp lhs,
                        cel_Timestamp rhs) {
  CEL_ASSERT_NOT_NULL(out);
  CEL_ASSERT(cel_Timestamp_Valid(lhs.sec, lhs.nsec));
