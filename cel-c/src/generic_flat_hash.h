...
// IWYU pragma: private
// IWYU pragma: friend "cel-c/src/(?:(?:arena|generic)_)?flat_hash(?:_(?:set|map))?\.[hc]"

#ifndef THIRD_PARTY_CEL_C_SRC_GENERIC_FLAT_HASH_H_
#define THIRD_PARTY_CEL_C_SRC_GENERIC_FLAT_HASH_H_
...
#endif  // THIRD_PARTY_CEL_C_SRC_GENERIC_FLAT_HASH_H_
