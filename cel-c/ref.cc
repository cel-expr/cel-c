...
extern "C" cel_RefKind cel_Ref_Kind(const cel_Ref* cel_nonnull ref) {
  CEL_ASSERT_NOT_NULL(ref);

  return ref->kind;
}

extern "C" cel_StringView cel_Ref_Name(const cel_Ref* cel_nonnull ref) {
  CEL_ASSERT_NOT_NULL(ref);

  return ref->name;
}

extern "C" cel_IdentRef* cel_nullable
...
extern "C" cel_FunctionRef* cel_nullable
...
extern "C" size_t cel_FunctionRef_Overloads(
...
extern "C" bool cel_FunctionRef_AppendOverload(
...
extern "C" cel_FunctionOverloadRef* cel_nullable
...
extern "C" cel_StringView cel_FunctionOverloadRef_Id(
