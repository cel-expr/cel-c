...
extern "C" const cel_Error* const cel_nonnull cel_DefaultError =
    &_cel_DefaultError;

extern "C" cel_Error* cel_nullable cel_Error_New(cel_Arena* cel_nonnull arena) {
...
extern "C" void cel_Error_Clear(cel_Error* cel_nonnull error) {
...
extern "C" cel_ErrorCode cel_Error_CanonicalCode(
...
extern "C" int cel_Error_Code(const cel_Error* cel_nonnull error) {
  CEL_ASSERT_NOT_NULL(error);

  return error->raw_code;
}

extern "C" void cel_Error_SetCode(cel_Error* cel_nonnull error,
...
extern "C" const cel_ErrorSpace* cel_nonnull
...
extern "C" cel_StringView cel_Error_Message(
    const cel_Error* cel_nonnull error) {
  CEL_ASSERT_NOT_NULL(error);
...
extern "C" void cel_Error_SetMessage(cel_Error* cel_nonnull error,
                                     cel_StringView message) {
  CEL_ASSERT_NOT_NULL(error);
...
extern "C" bool cel_Error_VFormatMessage(cel_Error* cel_nonnull error,
...
extern "C" bool cel_Error_NextPayload(
...
extern "C" size_t cel_Error_Payloads(const cel_Error* cel_nonnull error) {
  CEL_ASSERT_NOT_NULL(error);

  return error->payloads_len;
}

extern "C" bool cel_Error_GetPayload(const cel_Error* cel_nonnull error,
                                     cel_StringView type_url,
                                     cel_StringView* cel_nullable value) {
  CEL_ASSERT_NOT_NULL(error);
...
extern "C" bool cel_Error_SetPayload(cel_Error* cel_nonnull error,
                                     cel_StringView type_url,
                                     cel_StringView value,
                                     cel_Arena* cel_nonnull arena) {
  CEL_ASSERT_NOT_NULL(error);
...
extern "C" bool cel_Error_DeletePayload(cel_Error* cel_nonnull error,
                                        cel_StringView type_url,
                                        cel_StringView* cel_nullable value) {
  CEL_ASSERT_NOT_NULL(error);
  CEL_ASSERT_NOT(cel_StringView_Empty(type_url));
...
extern "C" void cel_Error_ClearPayloads(cel_Error* cel_nonnull error) {
  CEL_ASSERT_NOT_NULL(error);
