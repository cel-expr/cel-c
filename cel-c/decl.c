...
cel_DeclKind cel_Decl_Kind(const cel_Decl* cel_nonnull decl) {
  CEL_ASSERT_NOT_NULL(decl);

  return decl->kind;
}

cel_StringView cel_Decl_Name(const cel_Decl* cel_nonnull decl) {
  CEL_ASSERT_NOT_NULL(decl);

  return decl->name;
}

cel_StringView cel_Decl_Doc(const cel_Decl* cel_nonnull decl) {
  CEL_ASSERT_NOT_NULL(decl);

  return decl->doc;
}

void cel_Decl_SetDoc(cel_Decl* cel_nonnull decl, cel_StringView doc) {
  CEL_ASSERT_NOT_NULL(decl);

  decl->doc = doc;
}

cel_IdentDecl* cel_nullable cel_IdentDecl_New(cel_StringView name,
...
void cel_IdentDecl_SetType(cel_IdentDecl* cel_nonnull decl,
                           const cel_Type* cel_nonnull type) {
  CEL_ASSERT_NOT_NULL(decl);
...
size_t cel_FunctionDecl_Overloads(const cel_FunctionDecl* cel_nonnull decl,
                                  cel_FunctionOverloadDecl * cel_nullable *
                                      cel_nullable head,
                                  cel_FunctionOverloadDecl * cel_nullable *
                                      cel_nullable tail) {
  CEL_ASSERT_NOT_NULL(decl);
...
bool cel_FunctionDecl_AddOverload(cel_FunctionDecl* cel_nonnull decl,
                                  cel_FunctionOverloadDecl* cel_nonnull
                                      overload) {
  CEL_ASSERT_NOT_NULL(decl);
...
cel_FunctionOverloadDecl* cel_nullable cel_FunctionOverloadDecl_New(
...
cel_StringView cel_FunctionOverloadDecl_Id(
...
cel_StringView cel_FunctionOverloadDecl_Doc(
    const cel_FunctionOverloadDecl* cel_nonnull decl) {
  CEL_ASSERT_NOT_NULL(decl);
...
void cel_FunctionOverloadDecl_SetDoc(cel_FunctionOverloadDecl* cel_nonnull decl,
                                     cel_StringView doc) {
  CEL_ASSERT_NOT_NULL(decl);
...
cel_FunctionScope cel_FunctionOverloadDecl_Scope(
    const cel_FunctionOverloadDecl* cel_nonnull decl) {
  CEL_ASSERT_NOT_NULL(decl);
...
cel_FunctionDecl* cel_nullable cel_FunctionOverloadDecl_Function(
    const cel_FunctionOverloadDecl* cel_nonnull decl) {
  CEL_ASSERT_NOT_NULL(decl);
...
const cel_FunctionType* cel_nonnull cel_FunctionOverloadDecl_Type(
    const cel_FunctionOverloadDecl* cel_nonnull decl) {
  CEL_ASSERT_NOT_NULL(decl);
...
cel_FunctionOverloadDecl* cel_nullable cel_FunctionOverloadDecl_Prev(
    const cel_FunctionOverloadDecl* cel_nonnull decl) {
  CEL_ASSERT_NOT_NULL(decl);
...
cel_FunctionOverloadDecl* cel_nullable cel_FunctionOverloadDecl_Next(
    const cel_FunctionOverloadDecl* cel_nonnull decl) {
  CEL_ASSERT_NOT_NULL(decl);
