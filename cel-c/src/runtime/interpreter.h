...
#ifndef THIRD_PARTY_CEL_C_SRC_RUNTIME_INTERPRETER_H_
#define THIRD_PARTY_CEL_C_SRC_RUNTIME_INTERPRETER_H_
...
#endif  // THIRD_PARTY_CEL_C_SRC_RUNTIME_INTERPRETER_H_
