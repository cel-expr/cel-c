...
extern "C" bool cel_IsWellKnownMessageType(
...
extern "C" bool cel_IsWellKnownMessageTypeName(cel_StringView name) {
...
extern "C" bool cel_IsWellKnownEnumType(const upb_EnumDef* cel_nonnull def) {
  const char* name = upb_EnumDef_FullName(def);
  return name != cel_nullptr && strcmp(name, "google.protobuf.NullValue") == 0;
}

extern "C" bool cel_IsWellKnownEnumTypeName(cel_StringView name) {
...
extern "C" const cel_Type* const cel_nonnull cel_DynType = &_cel_DynType;

static const cel_Type _cel_NullType = {
    .kind = cel_TypeKind_kNull,
};

extern "C" const cel_Type* const cel_nonnull cel_NullType = &_cel_NullType;

static const cel_Type _cel_BoolType = {
    .kind = cel_TypeKind_kBool,
};

extern "C" const cel_Type* const cel_nonnull cel_BoolType = &_cel_BoolType;

static const cel_Type _cel_IntType = {
    .kind = cel_TypeKind_kInt,
};

extern "C" const cel_Type* const cel_nonnull cel_IntType = &_cel_IntType;

static const cel_Type _cel_UintType = {
    .kind = cel_TypeKind_kUint,
};

extern "C" const cel_Type* const cel_nonnull cel_UintType = &_cel_UintType;

static const cel_Type _cel_DoubleType = {
    .kind = cel_TypeKind_kDouble,
};

extern "C" const cel_Type* const cel_nonnull cel_DoubleType = &_cel_DoubleType;

static const cel_Type _cel_StringType = {
    .kind = cel_TypeKind_kString,
};

extern "C" const cel_Type* const cel_nonnull cel_StringType = &_cel_StringType;

static const cel_Type _cel_BytesType = {
    .kind = cel_TypeKind_kBytes,
};

extern "C" const cel_Type* const cel_nonnull cel_BytesType = &_cel_BytesType;

static const cel_Type _cel_AnyType = {
    .kind = cel_TypeKind_kAny,
};

extern "C" const cel_Type* const cel_nonnull cel_AnyType = &_cel_AnyType;

static const cel_Type _cel_DurationType = {
    .kind = cel_TypeKind_kDuration,
};

extern "C" const cel_Type* const cel_nonnull cel_DurationType =
    &_cel_DurationType;
...
extern "C" const cel_Type* const cel_nonnull cel_TimestampType =
    &_cel_TimestampType;
...
extern "C" const cel_Type* const cel_nonnull cel_UnknownType =
    &_cel_UnknownType;
...
extern "C" const cel_Type* const cel_nonnull cel_ErrorType = &_cel_ErrorType;

static const cel_Type _cel_BoolWrapperType = {
    .kind = cel_TypeKind_kBoolWrapper,
};

extern "C" const cel_Type* const cel_nonnull cel_BoolWrapperType =
    &_cel_BoolWrapperType;

static const cel_Type _cel_IntWrapperType = {
    .kind = cel_TypeKind_kIntWrapper,
};

extern "C" const cel_Type* const cel_nonnull cel_IntWrapperType =
    &_cel_IntWrapperType;
...
extern "C" const cel_Type* const cel_nonnull cel_UintWrapperType =
    &_cel_UintWrapperType;

static const cel_Type _cel_DoubleWrapperType = {
    .kind = cel_TypeKind_kDoubleWrapper,
};

extern "C" const cel_Type* const cel_nonnull cel_DoubleWrapperType =
...
extern "C" const cel_Type* const cel_nonnull cel_StringWrapperType =
...
extern "C" const cel_Type* const cel_nonnull cel_BytesWrapperType =
    &_cel_BytesWrapperType;

extern "C" cel_TypeKind cel_Type_Kind(const cel_Type* cel_nonnull type) {
  CEL_ASSERT_NOT_NULL(type);

  return type->kind;
}

extern "C" cel_StringView cel_Type_Name(const cel_Type* cel_nonnull type) {
  CEL_ASSERT_NOT_NULL(type);
...
extern "C" const cel_Type* cel_nonnull const* cel_nullability_unknown
...
extern "C" bool cel_Type_Equals(const cel_Type* cel_nonnull lhs,
...
extern "C" const cel_ListType* cel_nullable cel_ListType_New(
...
extern "C" bool cel_ListType_Equals(const cel_ListType* cel_nonnull lhs,
...
extern "C" const cel_MapType* cel_nullable cel_MapType_New(
...
extern "C" bool cel_MapType_Equals(const cel_MapType* cel_nonnull lhs,
...
extern "C" const cel_StructType* cel_nullable
...
extern "C" cel_StringView cel_StructType_Name(
    const cel_StructType* cel_nonnull type) {
  CEL_ASSERT_NOT_NULL(type);

  return type->name;
}

extern "C" bool cel_StructType_Equals(const cel_StructType* cel_nonnull lhs,
...
extern "C" const cel_EnumType* cel_nullable
...
extern "C" cel_StringView cel_EnumType_Name(
    const cel_EnumType* cel_nonnull type) {
  CEL_ASSERT_NOT_NULL(type);

  return type->name;
}

extern "C" bool cel_EnumType_Equals(const cel_EnumType* cel_nonnull lhs,
...
extern "C" cel_OpaqueType* cel_nullable
...
extern "C" cel_StringView cel_OpaqueType_Name(
...
extern "C" const cel_Type* const cel_nonnull* cel_nullability_unknown
...
extern "C" bool cel_OpaqueType_Equals(const cel_OpaqueType* cel_nonnull lhs,
...
extern "C" const cel_OptionalType* cel_nullable cel_OptionalType_New(
...
extern "C" const cel_TypeType* cel_nullable cel_TypeType_New(
...
extern "C" bool cel_TypeType_Equals(const cel_TypeType* cel_nonnull lhs,
...
extern "C" const cel_TypeParamType* cel_nullable
...
extern "C" cel_StringView cel_TypeParamType_Name(
...
extern "C" bool cel_TypeParamType_Equals(
...
extern "C" cel_FunctionType* cel_nullable
...
extern "C" bool cel_FunctionType_Equals(const cel_FunctionType* cel_nonnull lhs,
