...
cel_ProgramOptions* cel_nonnull
...
void cel_Program_Delete(cel_Program* cel_nullable prog) {
...
cel_Program* cel_nullable _cel_Program_New(const cel_Runtime* cel_nonnull rt) {
