...
extern "C" cel_ExprId cel_Ast_NextId(CEL_NONNULL(cel_Ast*) ast) {
  CEL_ASSERT_NOT_NULL(ast);

  return ++ast->next_id;
}

extern "C" cel_ExprId cel_Ast_MaxId(CEL_NONNULL(const cel_Ast*) ast) {
  CEL_ASSERT_NOT_NULL(ast);

  return ast->next_id;
}

extern "C" CEL_NULLABLE(cel_Expr*)
...
extern "C" CEL_NULLABLE(cel_Ast*) cel_Ast_New(CEL_NONNULL(cel_Arena*) arena) {
...
extern "C" void cel_Ast_Delete(CEL_NULLABLE(cel_Ast*) ast) {}
...
extern "C" cel_ExprKind cel_Expr_Kind(CEL_NONNULL(const cel_Expr*) expr) {
  CEL_ASSERT_NOT_NULL(expr);

  return expr->kind;
}

extern "C" cel_ExprId cel_Expr_Id(CEL_NONNULL(const cel_Expr*) expr) {
  CEL_ASSERT_NOT_NULL(expr);

  return expr->id;
}

extern "C" void cel_Expr_SetId(CEL_NONNULL(cel_Expr*) expr, cel_ExprId id) {
  CEL_ASSERT_NOT_NULL(expr);
  CEL_ASSERT_GE(id, 0);
...
extern "C" int32_t cel_Expr_SourcePosition(CEL_NONNULL(const cel_Expr*) expr) {
  CEL_ASSERT_NOT_NULL(expr);

  return expr->range.begin;
}

extern "C" cel_SourceRange cel_Expr_SourceRange(CEL_NONNULL(const cel_Expr*)
                                                    expr) {
  CEL_ASSERT_NOT_NULL(expr);
...
extern "C" void cel_Expr_SetSourcePosition(CEL_NONNULL(cel_Expr*) expr,
...
extern "C" void cel_Expr_SetSourceRange(CEL_NONNULL(cel_Expr*) expr,
...
extern "C" size_t cel_Expr_Depth(CEL_NONNULL(const cel_Expr*) expr) {
  CEL_ASSERT_NOT_NULL(expr);
...
extern "C" CEL_NULLABLE(const cel_Ref*)
...
extern "C" void cel_Expr_SetRef(CEL_NONNULL(cel_Expr*) expr,
                                CEL_NULLABLE(const cel_Ref*) ref) {
  CEL_ASSERT_NOT_NULL(expr);
...
extern "C" CEL_NONNULL(const cel_Type*)
...
extern "C" void cel_Expr_SetType(CEL_NONNULL(cel_Expr*) expr,
...
extern "C" CEL_NULLABLE(cel_UnspecifiedExpr*)
...
extern "C" CEL_NULLABLE(cel_IdentExpr*)
...
extern "C" cel_StringView cel_IdentExpr_Name(CEL_NONNULL(const cel_IdentExpr*)
                                                 expr) {
  CEL_ASSERT_NOT_NULL(expr);
...
extern "C" void cel_IdentExpr_SetName(CEL_NONNULL(cel_IdentExpr*) expr,
                                      cel_StringView name) {
  CEL_ASSERT_NOT_NULL(expr);
...
extern "C" CEL_NULLABLE(cel_ConstExpr*)
...
extern "C" CEL_NONNULL(const cel_Constant*)
...
extern "C" CEL_NONNULL(cel_Constant*)
...
extern "C" CEL_NULLABLE(cel_SelectExpr*)
...
extern "C" cel_StringView cel_SelectExpr_Field(
    CEL_NONNULL(const cel_SelectExpr*) expr) {
  CEL_ASSERT_NOT_NULL(expr);

  return expr->field;
}

extern "C" void cel_SelectExpr_SetField(CEL_NONNULL(cel_SelectExpr*) expr,
                                        cel_StringView field) {
  CEL_ASSERT_NOT_NULL(expr);
...
extern "C" bool cel_SelectExpr_TestOnly(CEL_NONNULL(const cel_SelectExpr*)
                                            expr) {
  CEL_ASSERT_NOT_NULL(expr);
...
extern "C" void cel_SelectExpr_SetTestOnly(CEL_NONNULL(cel_SelectExpr*) expr,
                                           bool test_only) {
  CEL_ASSERT_NOT_NULL(expr);
...
extern "C" CEL_NULLABLE(cel_CallArgExpr*)
...
extern "C" CEL_NULLABLE(cel_CallExpr*)
...
extern "C" ptrdiff_t cel_CallArgExpr_Index(CEL_NONNULL(const cel_CallArgExpr*)
                                               expr) {
  CEL_ASSERT_NOT_NULL(expr);
...
extern "C" cel_StringView cel_CallExpr_Function(CEL_NONNULL(const cel_CallExpr*)
                                                    expr) {
  CEL_ASSERT_NOT_NULL(expr);
...
extern "C" void cel_CallExpr_SetFunction(CEL_NONNULL(cel_CallExpr*) expr,
                                         cel_StringView function) {
  CEL_ASSERT_NOT_NULL(expr);
...
extern "C" void cel_CallExpr_AppendArg(CEL_NONNULL(cel_CallExpr*) expr,
...
extern "C" void cel_CallExpr_PrependArg(CEL_NONNULL(cel_CallExpr*) expr,
                                        CEL_NONNULL(cel_CallArgExpr*) arg) {
  CEL_ASSERT_NOT_NULL(expr);
...
extern "C" void cel_CallExpr_InsertArg(CEL_NONNULL(cel_CallExpr*) expr,
...
extern "C" CEL_NONNULL(cel_CallArgExpr*)
...
extern "C" size_t cel_CallExpr_Args(CEL_NONNULL(const cel_CallExpr*) expr,
                                    CEL_NULLABLE(cel_CallArgExpr*) *
                                        cel_nullable head,
                                    CEL_NULLABLE(cel_CallArgExpr*) *
                                        cel_nullable tail) {
...
extern "C" CEL_NULLABLE(cel_UnaryExpr*)
...
extern "C" cel_UnaryOp cel_UnaryExpr_Op(CEL_NONNULL(const cel_UnaryExpr*)
                                            expr) {
  CEL_ASSERT_NOT_NULL(expr);
...
extern "C" void cel_UnaryExpr_SetOp(CEL_NONNULL(cel_UnaryExpr*) expr,
                                    cel_UnaryOp op) {
  CEL_ASSERT_NOT_NULL(expr);
...
extern "C" CEL_NULLABLE(cel_BinaryExpr*)
...
extern "C" cel_BinaryOp cel_BinaryExpr_Op(CEL_NONNULL(const cel_BinaryExpr*)
                                              expr) {
  CEL_ASSERT_NOT_NULL(expr);
...
extern "C" void cel_BinaryExpr_SetOp(CEL_NONNULL(cel_BinaryExpr*) expr,
                                     cel_BinaryOp op) {
  CEL_ASSERT_NOT_NULL(expr);
...
extern "C" CEL_NULLABLE(cel_TernaryExpr*)
...
extern "C" cel_TernaryOp cel_TernaryExpr_Op(CEL_NONNULL(const cel_TernaryExpr*)
                                                expr) {
  CEL_ASSERT_NOT_NULL(expr);
...
extern "C" void cel_TernaryExpr_SetOp(CEL_NONNULL(cel_TernaryExpr*) expr,
                                      cel_TernaryOp op) {
  CEL_ASSERT_NOT_NULL(expr);
...
extern "C" CEL_NULLABLE(cel_ListElementExpr*)
...
extern "C" CEL_NULLABLE(cel_ListExpr*)
...
extern "C" ptrdiff_t cel_ListElementExpr_Index(
...
extern "C" bool cel_ListElementExpr_Optional(
    CEL_NONNULL(const cel_ListElementExpr*) expr) {
  CEL_ASSERT_NOT_NULL(expr);
...
extern "C" void cel_ListElementExpr_SetOptional(
...
extern "C" void cel_ListExpr_AppendElement(CEL_NONNULL(cel_ListExpr*) expr,
...
extern "C" void cel_ListExpr_PrependElement(CEL_NONNULL(cel_ListExpr*) expr,
                                            CEL_NONNULL(cel_ListElementExpr*)
                                                element) {
  CEL_ASSERT_NOT_NULL(expr);
...
extern "C" void cel_ListExpr_InsertElement(CEL_NONNULL(cel_ListExpr*) expr,
                                           CEL_NULLABLE(cel_ListElementExpr*)
                                               before,
                                           CEL_NONNULL(cel_ListElementExpr*)
                                               element) {
...
extern "C" CEL_NONNULL(cel_ListElementExpr*)
...
extern "C" size_t cel_ListExpr_Elements(CEL_NONNULL(const cel_ListExpr*) expr,
                                        CEL_NULLABLE(cel_ListElementExpr*) *
                                            cel_nullable head,
                                        CEL_NULLABLE(cel_ListElementExpr*) *
                                            cel_nullable tail) {
...
extern "C" CEL_NULLABLE(cel_MapEntryExpr*)
...
extern "C" CEL_NULLABLE(cel_MapExpr*)
...
extern "C" ptrdiff_t cel_MapEntryExpr_Index(CEL_NONNULL(const cel_MapEntryExpr*)
                                                expr) {
  CEL_ASSERT_NOT_NULL(expr);
...
extern "C" bool cel_MapEntryExpr_Optional(CEL_NONNULL(const cel_MapEntryExpr*)
                                              expr) {
  CEL_ASSERT_NOT_NULL(expr);
...
extern "C" void cel_MapEntryExpr_SetOptional(CEL_NONNULL(cel_MapEntryExpr*)
                                                 expr,
                                             bool optional) {
  CEL_ASSERT_NOT_NULL(expr);
...
extern "C" void cel_MapExpr_AppendEntry(CEL_NONNULL(cel_MapExpr*) expr,
...
extern "C" void cel_MapExpr_PrependEntry(CEL_NONNULL(cel_MapExpr*) expr,
                                         CEL_NONNULL(cel_MapEntryExpr*) entry) {
  CEL_ASSERT_NOT_NULL(expr);
...
extern "C" void cel_MapExpr_InsertEntry(CEL_NONNULL(cel_MapExpr*) expr,
...
extern "C" CEL_NONNULL(cel_MapEntryExpr*)
...
extern "C" size_t cel_MapExpr_Entries(CEL_NONNULL(const cel_MapExpr*) expr,
                                      CEL_NULLABLE(cel_MapEntryExpr*) *
                                          cel_nullable head,
                                      CEL_NULLABLE(cel_MapEntryExpr*) *
                                          cel_nullable tail) {
...
extern "C" CEL_NULLABLE(cel_StructFieldExpr*)
...
extern "C" CEL_NULLABLE(cel_StructExpr*)
...
extern "C" ptrdiff_t cel_StructFieldExpr_Index(
...
extern "C" cel_StringView cel_StructFieldExpr_Name(
    CEL_NONNULL(const cel_StructFieldExpr*) expr) {
  CEL_ASSERT_NOT_NULL(expr);
...
extern "C" void cel_StructFieldExpr_SetName(CEL_NONNULL(cel_StructFieldExpr*)
                                                expr,
                                            cel_StringView name) {
  CEL_ASSERT_NOT_NULL(expr);
...
extern "C" bool cel_StructFieldExpr_Optional(
    CEL_NONNULL(const cel_StructFieldExpr*) expr) {
  CEL_ASSERT_NOT_NULL(expr);
...
extern "C" void cel_StructFieldExpr_SetOptional(
...
extern "C" cel_StringView cel_StructExpr_Name(CEL_NONNULL(const cel_StructExpr*)
                                                  expr) {
  CEL_ASSERT_NOT_NULL(expr);
...
extern "C" void cel_StructExpr_SetName(CEL_NONNULL(cel_StructExpr*) expr,
                                       cel_StringView name) {
  CEL_ASSERT_NOT_NULL(expr);
...
extern "C" void cel_StructExpr_AppendField(CEL_NONNULL(cel_StructExpr*) expr,
...
extern "C" void cel_StructExpr_PrependField(CEL_NONNULL(cel_StructExpr*) expr,
                                            CEL_NONNULL(cel_StructFieldExpr*)
                                                field) {
  CEL_ASSERT_NOT_NULL(expr);
...
extern "C" void cel_StructExpr_InsertField(CEL_NONNULL(cel_StructExpr*) expr,
                                           CEL_NULLABLE(cel_StructFieldExpr*)
                                               before,
                                           CEL_NONNULL(cel_StructFieldExpr*)
                                               field) {
...
extern "C" CEL_NONNULL(cel_StructFieldExpr*)
...
extern "C" CEL_NONNULL(cel_StructFieldExpr*)
    cel_StructExpr_Field(CEL_NONNULL(const cel_StructExpr*) expr,
                         size_t index) {
  CEL_ASSERT_NOT_NULL(expr);
...
extern "C" size_t cel_StructExpr_Fields(CEL_NONNULL(const cel_StructExpr*) expr,
                                        CEL_NULLABLE(cel_StructFieldExpr*) *
                                            cel_nullable head,
                                        CEL_NULLABLE(cel_StructFieldExpr*) *
                                            cel_nullable tail) {
...
extern "C" CEL_NULLABLE(cel_ComprehensionExpr*)
...
extern "C" cel_StringView cel_ComprehensionExpr_IterVar(
...
extern "C" void cel_ComprehensionExpr_SetIterVar(
...
extern "C" cel_StringView cel_ComprehensionExpr_IterVar2(
    CEL_NONNULL(const cel_ComprehensionExpr*) expr) {
  CEL_ASSERT_NOT_NULL(expr);
...
extern "C" void cel_ComprehensionExpr_SetIterVar2(
...
extern "C" cel_StringView cel_ComprehensionExpr_AccuVar(
    CEL_NONNULL(const cel_ComprehensionExpr*) expr) {
  CEL_ASSERT_NOT_NULL(expr);
...
extern "C" void cel_ComprehensionExpr_SetAccuVar(
...
extern "C" CEL_NULLABLE(cel_Expr*) cel_ComprehensionExpr_LoopCondition(
    CEL_NONNULL(const cel_ComprehensionExpr*) expr) {
  CEL_ASSERT_NOT_NULL(expr);
...
extern "C" CEL_NULLABLE(cel_Expr*) cel_ComprehensionExpr_ReleaseLoopCondition(
