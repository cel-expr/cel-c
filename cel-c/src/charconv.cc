...
extern "C" _cel_FromCharsResult _cel_FromChars_signed(
    const char* cel_nonnull first, const char* cel_nonnull last,
    long long* cel_nonnull val, int base, long long min, long long max) {
...
extern "C" _cel_FromCharsResult _cel_FromChars_unsigned(
    const char* cel_nonnull first, const char* cel_nonnull last,
...
extern "C" _cel_FromCharsResult _cel_FromChars_f(const char* cel_nonnull first,
                                                 const char* cel_nonnull last,
...
extern "C" _cel_FromCharsResult _cel_FromChars_d(const char* cel_nonnull first,
                                                 const char* cel_nonnull last,
...
extern "C" size_t _cel_ToChars_ll(char* cel_nonnull out, long long val,
                                  int base) {
...
extern "C" size_t _cel_ToChars_ull(char* cel_nonnull out,
...
extern "C" size_t _cel_ToChars_f(char* cel_nonnull first, float val) {
  first[0] = '\0';
  snprintf(first, _CEL_MAX_FLOAT_CHARS, "%.9g", val);
  return _cel_ToChars_FixLocale(first);
}

extern "C" size_t _cel_ToChars_d(char* cel_nonnull first, double val) {
  first[0] = '\0';
