...
extern const cel_OptionalValueVTable _cel_OptionalValueVTables[11];
...
const cel_OptionalValueVTable _cel_OptionalValueVTables[11] = {
...
extern "C" bool cel_OptionalValue_Of(
    cel_OptionalValue* cel_nonnull optional_value,
...
extern "C" bool cel_Value_IsOptional(const cel_Value* cel_nonnull value) {
  return cel_Value_IsOpaque(value) &&
         _cel_OpaqueValue_IsOptional(cel_Value_GetOpaque(value));
}

extern "C" bool cel_OpaqueValue_IsOptional(
