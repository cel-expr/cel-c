...
size_t cel_CStringView_Count(cel_CStringView haystack, cel_CStringView needle) {
...
bool cel_CStringViewTokenizer_Next(
...
bool cel_CStringView_EqualsIgnoreCase(cel_CStringView lhs,
                                      cel_CStringView rhs) {
