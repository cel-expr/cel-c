...
void cel_Status_Construct(CEL_NONNULL(cel_Status*) status) {
...
void cel_Status_Destruct(CEL_NONNULL(cel_Status*) status) {
  CEL_ASSERT_NOT_NULL(status);
...
void cel_Status_Clear(CEL_NONNULL(cel_Status*) status) {
  CEL_ASSERT_NOT_NULL(status);
...
void cel_Status_Reset(CEL_NONNULL(cel_Status*) status) {
  CEL_ASSERT_NOT_NULL(status);
...
int cel_Status_Code(CEL_NONNULL(const cel_Status*) status) {
  CEL_ASSERT_NOT_NULL(status);

  return _cel_Status_Rep(status)->raw_code;
}

cel_StringView cel_Status_Message(CEL_NONNULL(const cel_Status*) status) {
  CEL_ASSERT_NOT_NULL(status);

  return _cel_String_ToStringView(&_cel_Status_Rep(status)->message);
}

void cel_Status_SetCode(CEL_NONNULL(cel_Status*) status,
...
bool cel_Status_SetMessage(CEL_NONNULL(cel_Status*) status,
...
void cel_OutOfMemoryStatus(CEL_NONNULL(cel_Status*) status,
                           CEL_NONNULL(const char*) file, int line) {
  CEL_ASSERT_NOT_NULL(status);
  CEL_ASSERT_NOT_NULL(file);
  CEL_ASSERT_GT(line, 0);
...
bool cel_Status_VFormatMessage(CEL_NONNULL(cel_Status*) status,
                               CEL_NONNULL(const char*) file, int line,
...
bool cel_Status_GetPayload(CEL_NONNULL(const cel_Status*) status,
...
bool cel_Status_SetPayload(CEL_NONNULL(cel_Status*) status,
                           cel_StringView type_url, cel_StringView value,
                           CEL_NONNULL(const char*) file, int line) {
  CEL_ASSERT_NOT_NULL(status);
  CEL_ASSERT_NOT_NULL(file);
  CEL_ASSERT_GT(line, 0);
...
bool cel_Status_DeletePayload(CEL_NONNULL(cel_Status*) status,
                              cel_StringView type_url) {
  CEL_ASSERT_NOT_NULL(status);
...
bool cel_Status_NextPayload(CEL_NONNULL(const cel_Status*) status,
                            CEL_NULLABLE(cel_StringView*) type_url,
                            CEL_NULLABLE(cel_StringView*) value,
                            CEL_NONNULL(cel_StatusPayloadIterator*) iter) {
  CEL_ASSERT_NOT_NULL(status);
...
size_t cel_Status_Payloads(CEL_NONNULL(const cel_Status*) status) {
  CEL_ASSERT_NOT_NULL(status);
...
void cel_Status_ClearPayloads(CEL_NONNULL(cel_Status*) status) {
  CEL_ASSERT_NOT_NULL(status);
