...
const char* cel_nullable cel_StringView_FindFirst(cel_StringView haystack,
                                                  cel_StringView needle) {
  return _cel_Memory_FindFirst(
      cel_StringView_Data(haystack), cel_StringView_Size(haystack),
      cel_StringView_Data(needle), cel_StringView_Size(needle));
}

const char* cel_nullable cel_StringView_FindLast(cel_StringView haystack,
                                                 cel_StringView needle) {
  return _cel_Memory_FindLast(
      cel_StringView_Data(haystack), cel_StringView_Size(haystack),
      cel_StringView_Data(needle), cel_StringView_Size(needle));
}

size_t cel_StringView_Count(cel_StringView haystack, cel_StringView needle) {
...
bool cel_StringViewTokenizer_Next(cel_StringViewTokenizer* cel_nonnull
                                      tokenizer,
...
bool cel_StringView_EqualsIgnoreCase(cel_StringView lhs, cel_StringView rhs) {
