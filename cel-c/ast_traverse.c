...
void cel_AstTraverser_Delete(CEL_NULLABLE(cel_AstTraverser*) ast_traverser) {
  if (ast_traverser == cel_nullptr) {
    return;
  }
...
void cel_AstTraverser_StepIn(cel_AstTraverser* cel_nonnull ast_traverser) {
...
void cel_AstTraverser_StepOut(cel_AstTraverser* cel_nonnull ast_traverser) {
  CEL_ASSERT_NOT_NULL(ast_traverser);
...
void cel_AstTraverser_StepOver(cel_AstTraverser* cel_nonnull ast_traverser) {
  CEL_ASSERT_NOT_NULL(ast_traverser);
...
bool cel_AstTraverser_Traverse(CEL_NONNULL(cel_AstTraverser*) ast_traverser,
                               CEL_NONNULL(cel_Status*) status) {
  CEL_ASSERT_NOT_NULL(ast_traverser);
