...
extern "C" cel_ActivationOptions* cel_nonnull
...
extern "C" cel_Trilean cel_Activation_FindVariable(
...
extern "C" bool cel_Activation_Execute(cel_Activation* cel_nonnull activation,
