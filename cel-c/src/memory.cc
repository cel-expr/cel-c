...
#ifndef __GLIBC__
static inline void* memrchr(const void* b, int c, size_t len) {
  if (len > 0) {
...
extern "C" bool _cel_Memory_Equals(CEL_NULLABLE(const void*) lhs_data,
                                   size_t lhs_size,
                                   CEL_NULLABLE(const void*) rhs_data,
                                   size_t rhs_size) {
...
extern "C" int _cel_Memory_Compare(CEL_NULLABLE(const void*) lhs_data,
                                   size_t lhs_size,
                                   CEL_NULLABLE(const void*) rhs_data,
                                   size_t rhs_size) {
  CEL_ASSERT(lhs_size == 0 || lhs_data != cel_nullptr);
...
extern "C" bool _cel_Memory_StartsWith(CEL_NULLABLE(const void*) hay_data,
                                       size_t hay_size,
...
extern "C" bool _cel_Memory_EndsWith(CEL_NULLABLE(const void*) hay_data,
                                     size_t hay_size,
                                     CEL_NULLABLE(const void*) ndl_data,
                                     size_t ndl_size) {
  CEL_ASSERT(hay_size == 0 || hay_data != cel_nullptr);
