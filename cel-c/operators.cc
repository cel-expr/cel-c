...
extern "C" bool cel_UnaryOp_FromString(cel_StringView str,
...
extern "C" cel_StringView cel_UnaryOp_ToString(cel_UnaryOp op) {
  CEL_ASSERT_GE(op, 0);
  CEL_ASSERT_LT(static_cast<int>(op), cel_arraysize(cel_kUnaryOpData));

  return cel_kUnaryOpData[op].string;
}

extern "C" int cel_UnaryOp_Precedence(cel_UnaryOp op) {
  CEL_ASSERT_GE(op, 0);
  CEL_ASSERT_LT(static_cast<int>(op), cel_arraysize(cel_kUnaryOpData));
...
extern "C" bool cel_BinaryOp_FromString(cel_StringView str,
...
extern "C" cel_StringView cel_BinaryOp_ToString(cel_BinaryOp op) {
  CEL_ASSERT_GE(op, 0);
  CEL_ASSERT_LT(static_cast<int>(op), cel_arraysize(cel_kBinaryOpData));

  return cel_kBinaryOpData[op].string;
}

extern "C" int cel_BinaryOp_Precedence(cel_BinaryOp op) {
  CEL_ASSERT_GE(op, 0);
  CEL_ASSERT_LT(static_cast<int>(op), cel_arraysize(cel_kBinaryOpData));
...
extern "C" bool cel_TernaryOp_FromString(cel_StringView str,
...
extern "C" cel_StringView cel_TernaryOp_ToString(cel_TernaryOp op) {
  CEL_ASSERT_GE(op, 0);
  CEL_ASSERT_LT(static_cast<int>(op), cel_arraysize(cel_kTernaryOpData));

  return cel_kTernaryOpData[op].string;
}

extern "C" int cel_TernaryOp_Precedence(cel_TernaryOp op) {
  CEL_ASSERT_GE(op, 0);
  CEL_ASSERT_LT(static_cast<int>(op), cel_arraysize(cel_kTernaryOpData));
