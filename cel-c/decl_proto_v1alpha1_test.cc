...
class DeclFromProtoV1Alpha1Test : public ::testing::Test {
 public:
  void SetUp() override {
 ...
 protected:
  ...
  google_api_expr_v1alpha1_Decl* ParseTextProto(absl::string_view text) {
    google::api::expr::v1alpha1::Decl proto;
    ...
    return ABSL_DIE_IF_NULL(google_api_expr_v1alpha1_Decl_parse(
...
TEST_F(DeclFromProtoV1Alpha1Test, Ident) {
  cel_Decl* decl = cel_Decl_FromProtoV1Alpha1(
...
TEST_F(DeclFromProtoV1Alpha1Test, Function) {
  cel_Decl* decl = cel_Decl_FromProtoV1Alpha1(
      ParseTextProto(R"pb(name: "foo"
                          function: {
                            overloads: {
