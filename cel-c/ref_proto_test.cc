...
class RefFromProtoTest : public ::testing::Test {
 public:
  void SetUp() override {
 ...
 protected:
  ...
  cel_expr_Reference* ParseTextProto(absl::string_view text) {
    cel::expr::Reference proto;
    ...
    return ABSL_DIE_IF_NULL(cel_expr_Reference_parse(
...
TEST_F(RefFromProtoTest, Ident) {
  cel_Ref* ref =
      cel_Ref_FromProto(ParseTextProto(R"pb(name: "foo"
...
TEST_F(RefFromProtoTest, Function) {
  cel_Ref* ref =
      cel_Ref_FromProto(ParseTextProto(R"pb(name: "foo"
