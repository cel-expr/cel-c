...
#ifndef THIRD_PARTY_CEL_C_SRC_RUNTIME_INTERPRETABLE_H_
#define THIRD_PARTY_CEL_C_SRC_RUNTIME_INTERPRETABLE_H_
...
#endif  // THIRD_PARTY_CEL_C_SRC_RUNTIME_INTERPRETABLE_H_
